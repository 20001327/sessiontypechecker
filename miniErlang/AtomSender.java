...
public class AtomSender extends SenderId implements Cloneable {
  ...
  public AtomSender(String p0) {
    setIdent(p0);
  }
  /**
   * @declaredat ASTNode:20
   */
  public AtomSender(beaver.Symbol p0) {
    setIdent(p0);
  }
  /** @apilevel low-level 
   ...
   */
  public AtomSender clone() throws CloneNotSupportedException {
    AtomSender node = (AtomSender) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:43
   */
  public AtomSender copy() {
    try {
      AtomSender node = (AtomSender) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public AtomSender treeCopyNoTransform() {
    AtomSender tree = (AtomSender) copy();
    if (children != null) {
   ...
   * @apilevel high-level
   */
  public AtomSender setIdent(String value) {
   ...
   * @apilevel internal
   */
  public AtomSender setIdent(beaver.Symbol symbol) {
