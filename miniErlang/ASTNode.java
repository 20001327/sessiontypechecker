...
/** @apilevel internal */
protected boolean indent_visited = false;
  /**
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat C:\\Users\\Lorenzo\\IdeaProjects\\TwoBuyerProtocol\\spec\\PrettyPrint.jrag:27
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="PrettyPrint", declaredAt="C:\\Users\\Lorenzo\\IdeaProjects\\TwoBuyerProtocol\\spec\\PrettyPrint.jrag:27")
  public String indent() {
    if (indent_visited) {
      throw new RuntimeException("Circular definition of attribute ASTNode.indent().");
    }
    indent_visited = true;
    try {
      ...
      indent_visited = false;
    }
  }
/** @apilevel internal */
protected boolean extractIndent_visited = false;
  /**
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat C:\\Users\\Lorenzo\\IdeaProjects\\TwoBuyerProtocol\\spec\\PrettyPrint.jrag:34
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="PrettyPrint", declaredAt="C:\\Users\\Lorenzo\\IdeaProjects\\TwoBuyerProtocol\\spec\\PrettyPrint.jrag:34")
  public String extractIndent() {
    if (extractIndent_visited) {
      throw new RuntimeException("Circular definition of attribute ASTNode.extractIndent().");
    }
    extractIndent_visited = true;
    try {
            if (getParent() == null)
                return "";
...
protected boolean addsIndentationLevel_visited = false;
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat C:\\Users\\Lorenzo\\IdeaProjects\\TwoBuyerProtocol\\spec\\PrettyPrint.jrag:46
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  ...
  public PrettyPrinter Define_printer(ASTNode _callerNode, ASTNode _childNode) {
    ...
    while (parent != null && !parent.canDefine_printer(self, _callerNode)) {
      _callerNode = self;
      self = parent;
      parent = self.getParent();
    }
    return parent.Define_printer(self, _callerNode);
  }
