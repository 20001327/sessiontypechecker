...
/**
 * @ast node
 * @declaredat C:\\Users\\Lorenzo\\IdeaProjects\\TwoBuyerProtocol\\spec\\FErlangNew.ast:29
 * @astdecl Literal : Pattern;
 * @production Literal : {@link Pattern};

 */
public abstract class Literal extends Pattern implements Cloneable {
  /**
