 ...
 * @astdecl Self : Expression;
 * @production Self : {@link Expression};

 */
public class Self extends Expression implements Cloneable {
  /**
   ...
   */
  public Self treeCopyNoTransform() {
    Self tree = (Self) copy();
    if (children != null) {
